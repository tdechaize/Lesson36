# Lesson36
Lesson36 OpenGL (from NeHe)

vous trouverez dans le sommaire ci-dessous les explication vous permettant de regénérer cette application montrant un des usages d'OpenGL :
le Radial Blur (issu di site NeHe).
...
Voici un résumé succinct des possibilités offertes par cette application :
  
## OpenGL Tutorial #36.

Project Name: Jeff Molofee's OpenGL Tutorial

Project Description : Radial Blur Tutorial

Authors Name: rIO & Jeff Molofee (aka NeHe)
